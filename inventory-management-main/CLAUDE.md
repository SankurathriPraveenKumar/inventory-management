...
- **vue-saas-redesign** skill: Use when asked to redesign the UI into a sidebar layout, modernize the app's look, or apply a SaaS-style interface to the Vue 3 frontend
